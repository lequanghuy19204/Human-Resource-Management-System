...
<head>
    ...
    <title>${empty organization ? 'Thêm' : 'Sửa'} Tổ chức - HRMS</title>
...
<body>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">${empty organization ? 'Thêm mới' : 'Cập nhật'} Tổ chức</h4>
                    </div>
                    <div class="card-body">
                        <form id="organizationForm" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                <label for="positionIds" class="form-label">Vị trí</label>
                                <select class="form-select" id="positionIds" multiple>
                                </select>
                            </div>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    ${empty organization ? 'Thêm mới' : 'Cập nhật'}
                                </button>
                            </div>
                        </form>
                    </div>
    ...
    <script src="../static/js/organization-form.js"></script>
</body>
</html> 